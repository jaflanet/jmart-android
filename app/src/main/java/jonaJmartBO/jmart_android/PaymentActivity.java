...
import jonaJmartBO.jmart_android.request.CreatePaymentRequest;
import jonaJmartBO.jmart_android.request.CreateProductRequest;
import jonaJmartBO.jmart_android.request.RequestFactory;
...
public class PaymentActivity extends AppCompatActivity {
    public static final String EXTRA_AMOUNT = "jonaJmartBO.jmart_android.EXTRA_AMOUNT";
    public static final String EXTRA_SHIPMENTADDRESS = "jonaJmartBO.jmart_android.EXTRA_SHIPMENTADDRESS";
