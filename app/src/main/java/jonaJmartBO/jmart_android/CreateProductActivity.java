...
public class CreateProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_createProductName = findViewById(R.id.inputProductName);
        et_createProductPrice = findViewById(R.id.inputProductPrice);
        et_createProductWeight = findViewById(R.id.inputProductWeight);
        et_createProductDiscount = findViewById(R.id.inputProductDiscount);
        ...
        btnCreateProduct = findViewById(R.id.buttonCreateProduct);
